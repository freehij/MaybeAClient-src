...
public abstract class Minecraft implements Runnable {
    ...
    public int displayWidth, prevWidth;
    public int displayHeight, prevHeight;
    ...
    public void startGame() throws LWJGLException {
        ...
        Display.setTitle("Minecraft Minecraft Beta 1.4_01");
        ...
        try {
            ...
            for(int var14 = (var5 - 1) / var3 * var3; var14 >= 0; var14 -= var3) {
                for(int var15 = 0; var15 < var4; var15 += var2) {
                    ...
                    GL11.glReadPixels(0, 0, var2, var3, 32992 /*GL_BGR_EXT*/, 5121 /*GL_UNSIGNED_BYTE*/, var6);
