...
public class BlockChest extends BlockContainer {
	...
	public void onBlockRemoval(World var1, int var2, int var3, int var4) {
		...
		if(var5 == null) return; //XXX fix worlddl crash
	...
	public boolean blockActivated(World world, int x, int y, int z, EntityPlayer var5) {
		Object var6 = (TileEntityChest)world.getBlockTileEntity(x, y, z);
		if (world.isBlockOpaqueCube(x, y + 1, z)) {
			return true;
		} else if (world.getBlockId(x - 1, y, z) == this.blockID && world.isBlockOpaqueCube(x - 1, y + 1, z)) {
			return true;
		} else if (world.getBlockId(x + 1, y, z) == this.blockID && world.isBlockOpaqueCube(x + 1, y + 1, z)) {
			return true;
		} else if (world.getBlockId(x, y, z - 1) == this.blockID && world.isBlockOpaqueCube(x, y + 1, z - 1)) {
			return true;
		} else if (world.getBlockId(x, y, z + 1) == this.blockID && world.isBlockOpaqueCube(x, y + 1, z + 1)) {
			return true;
		} else {
