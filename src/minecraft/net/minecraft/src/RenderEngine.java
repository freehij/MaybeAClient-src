...
public class RenderEngine {
    ...
    public HashMap field_28151_c = new HashMap();
    public HashMap textureNameToImageMap = new HashMap();
    public IntBuffer singleIntBuffer = GLAllocation.createDirectIntBuffer(1);
    public ByteBuffer imageData = GLAllocation.createDirectByteBuffer(1048576);
    public List textureList = new ArrayList();
    public Map urlToImageDataMap = new HashMap();
    public GameSettings options;
    public boolean clampTexture = false;
    public boolean blurTexture = false;
    public TexturePackList texturePack;
    public BufferedImage missingTextureImage = new BufferedImage(64, 64, 2);
    ...
    public int[] func_28148_b(BufferedImage var1) {
    ...
    public int[] func_28147_a(BufferedImage var1, int[] var2) {
    ...
    public BufferedImage unwrapImageByColumns(BufferedImage var1) {
    ...
    public BufferedImage readTextureImage(InputStream var1) throws IOException {
