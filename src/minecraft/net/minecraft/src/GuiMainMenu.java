...
public class GuiMainMenu extends GuiScreen {
    ...
    public GuiMainMenu() {
        ...
        try {
			...
			var1.add("very real maybeaclient team sea slug edition");
			var1.add("relique is def ratted");
			var1.add("hai bee4bee pwease join 2beta <3");
			var1.add("hai bee4bee pwease join alphaanarchy <3");
			if(Client.debug) ;
